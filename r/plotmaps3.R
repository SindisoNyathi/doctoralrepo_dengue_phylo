...
rate_parameters_evidence_support <- subset(rate_parameters_evidence, Bayes_Factor > 0 | Bayes_Factor < -0)
...
rate_parameters_evidence_support_median <- rate_parameters_evidence_support[which(rate_parameters_evidence_support$Median > ninetieth_quantile),]
...
rate_parameters_evidence_importations$Nudge_lat[which(rate_parameters_evidence_importations$Lat.x > -0.39605)] <- rate_parameters_evidence_importations$Nudge_lat[which(rate_parameters_evidence_importations$Lat.x > -0.39605)] + 3
rate_parameters_evidence_importations$Nudge_lat[which(rate_parameters_evidence_importations$Lat.x < -0.39605)] <- rate_parameters_evidence_importations$Nudge_lat[which(rate_parameters_evidence_importations$Lat.x < -0.39605)] - 3

rate_parameters_evidence_importations$Nudge_long[which(rate_parameters_evidence_importations$Long.x > 37.55609)] <- rate_parameters_evidence_importations$Nudge_long[which(rate_parameters_evidence_importations$Long.x > 37.55609)] + 8
rate_parameters_evidence_importations$Nudge_long[which(rate_parameters_evidence_importations$Long.x < 29.55609)] <- rate_parameters_evidence_importations$Nudge_long[which(rate_parameters_evidence_importations$Long.x < 29.55609)] - 10
#### DO NOT TOUCH THESE FOUR LINES. THEY ARE CURSED BUT THEY WORK###
...
global_transmission_network_importations <- ggplot() +
  ...
  # Add other regions
  geom_point(data = rate_parameters_evidence_importations, aes(x = Long.x, y = Lat.x), size = 4, color = "black", shape = 16) + 
...
geom_curve(data=rate_parameters_evidence_importations, aes(x = Long.x, y = Lat.x, xend = Long.y, yend = Lat.y, size = Bayes), curvature = 0.1, 
  ...
  geom_text(data=rate_parameters_evidence_importations, aes(label = Label.x, x = Long.x, y = Lat.x),
            nudge_y = rate_parameters_evidence_importations$Nudge_lat, nudge_x = rate_parameters_evidence_importations$Nudge_long, size = 4) + 
...
rate_parameters_evidence_exportations$Nudge_lat[which(rate_parameters_evidence_exportations$Lat.y > -0.39605)] <- rate_parameters_evidence_exportations$Nudge_lat[which(rate_parameters_evidence_exportations$Lat.y > -0.39605)] + 3
rate_parameters_evidence_exportations$Nudge_lat[which(rate_parameters_evidence_exportations$Lat.y < -0.39605)] <- rate_parameters_evidence_exportations$Nudge_lat[which(rate_parameters_evidence_exportations$Lat.y < -0.39605)] - 3

rate_parameters_evidence_exportations$Nudge_long[which(rate_parameters_evidence_exportations$Long.y > 37.55609)] <- rate_parameters_evidence_exportations$Nudge_long[which(rate_parameters_evidence_exportations$Long.y > 37.55609)] + 8
rate_parameters_evidence_exportations$Nudge_long[which(rate_parameters_evidence_exportations$Long.y < 29.55609)] <- rate_parameters_evidence_exportations$Nudge_long[which(rate_parameters_evidence_exportations$Long.y < 29.55609)] - 10
#### DO NOT TOUCH THESE FOUR LINES. THEY ARE CURSED BUT THEY WORK###
...
global_transmission_network_exportations <- ggplot() +
  ...
  # Add other regions
  geom_point(data = rate_parameters_evidence_exportations, aes(x = Long.y, y = Lat.y), size = 4, color = "black", shape = 16) + 
  ...
  geom_text(data=rate_parameters_evidence_exportations, aes(label = Label.y, x = Long.y, y = Lat.y),
            nudge_y = rate_parameters_evidence_exportations$Nudge_lat, nudge_x = rate_parameters_evidence_exportations$Nudge_long, size = 4) + 
...
global_transmission_local <- ggplot(data = world, size = 5) +
  ...
  # Add Kenya sites. 
  geom_sf(data = kenya_sites_sf, size = 9.5, shape = 20, fill = "black") + 
  ...
  # Add connecting paths
  geom_curve(data=rate_parameters_evidence_local, aes(x = Long.x, y = Lat.x, xend = Long.y, yend = Lat.y, size = Bayes), curvature = 0.2, 
             arrow = arrow(angle = 15, length = unit(0.25, "inches"),
                           ends = "last", type = "closed"), linetype = 'solid', color = 'black') +
  
  # Color scale
  #scale_color_gradient(name = "Inferred Transmission \nRate (units)", low = "blue", high = "red", limits = c(0.5, 2.5), breaks = c(0.5, 1, 1.5, 2, 2.5)) +
...
global_transmission_global <- ggplot() +
  ...
  #Add connection lines
  # Will add median and support and legend. 
  geom_curve(data=rate_parameters_evidence_global, aes(x = Long.x, y = Lat.x, xend = Long.y, yend = Lat.y, size = Bayes), curvature = 0.1, 
             arrow = arrow(angle = 15, length = unit(0.2, "inches"),
  ...
  geom_text(data=rate_parameters_evidence_global, aes(label = Label.y, x = Long.y, y = Lat.y),
            nudge_y = rate_parameters_evidence_global$Nudge_lat, nudge_x = rate_parameters_evidence_global$Nudge_long, size = 4) + 
