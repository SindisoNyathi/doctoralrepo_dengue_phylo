...
#SBATCH --output=/labs/dlabeaud/snyathi_1/analytic_pipeline/Logs/fastreebycountry/fasttreebycountry_%a.out
#SBATCH --error=/labs/dlabeaud/snyathi_1/analytic_pipeline/Logs/fastreebycountry/fasttreebycountry_%a.err
...
# Preliminaries
# Progress message
echo Creating fastrees given countries inthe file
...
sbatch Scripts/fastreebycountry_array_single.sh $SLURM_ARRAY_TASK_ID
