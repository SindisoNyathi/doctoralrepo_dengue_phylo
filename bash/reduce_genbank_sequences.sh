#!/bin/bash
#SBATCH --job-name=denv2_align_genbank_sequences
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
cd /labs/dlabeaud/snyathi_1/phylo_analyses/Data/denv2/gen_bank_sequences/Original
...
mafft --thread ${SLURM_CPUS_PER_TASK} --auto $LINE > /labs/dlabeaud/snyathi_1/phylo_analyses/Data/denv2/gen_bank_sequences/Aligned/aligned_$LINE
